                    ...
                    <div className="first-screen flex flex-col justify-center items-center md:h-[88vh] h-[30vh] text-center">
                     ...
                     <div className="second-screen md:h-screen    flex   justify-center ">
                        <div className='  w-[90vw]  '>
                                ...
                                <div className=" text-prim font-bold text-6xl md:text-[8vw]  leading-none ml-3.5 w-[30vw] " ref={trueClarity} >
                                    TRUE CLARITY
                                </div>
                                <div className="flex flex-col gap-[5vh]">
                                <div className='md:w-[30vw] w-[70vw] text-[20px] font-dm-sans text-prim' ref={paragraph}>
                                ...
                                <div className="boxes flex md:flex-row flex-col gap-5 mt-10" ref={boxes}>
                                    <div className="box box1">
                                            <div className='flex flex-col text-center md:gap-2 gap-4.5'>
                                                <div className='font-outfit md:text-[20px] text-3xl'>
                                                     Crystal-Clear Audio
                                                </div>
                                                <div className='font-dm-sans md:text-[18px]'>
